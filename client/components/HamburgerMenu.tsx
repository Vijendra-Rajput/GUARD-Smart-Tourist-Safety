          ...
          <div className="md:hidden w-full">
            <div className="w-full bg-card p-3 shadow rounded-b-md mt-2">
              ...
              <nav aria-label="Mobile menu">
                ...
                <div className="mt-3">
                  <button
                    className="w-full text-left px-3 py-2 rounded-md text-sm bg-accent text-accent-foreground"
                    onClick={() => {
                      window.dispatchEvent(new Event("open-ai-guide"));
                      setOpen(false);
                    }}
                  >
                    AI Guide
