    ...
    <div className="flex items-center gap-2">
      ...
      >
        ...
        <rect
          x="4"
          y="9"
          width={`${(12 * Math.max(0, Math.min(100, value))) / 100}`}
          height="6"
          rx="1"
          fill="currentColor"
          opacity="0.6"
...
function IconSignal({ value }: { value: number }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        <path
          d="M3 21h2V14H3v7zM8 21h2V11H8v10zM13 21h2V8h-2v13zM18 21h2V4h-2v17z"
          fill="currentColor"
          opacity="0.9"
        />
      </svg>
    ...
    <div className="container mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Overview of connected wearable devices
        </p>
      </div>
          ...
          >
            ...
            <CardFooter>
              <div className="text-xs text-muted-foreground">
                Last update: {timeAgo(d.lastUpdate)}
              </div>
            </CardFooter>
          </Card>
        ))}
