  ...
  return (
    <div className="space-y-8 p-8">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button className="bg-[#4F46E5] text-white">
                Create New Post
              </Button>
            </div>
          </div>
        ...
        <CardContent>
          <div className="grid gap-4">
            {[
              {
                title: "Stay safe on mountain trails",
              ...
              {
                title: "Best offline maps for Himachal",
                category: "Tips",
                author: "Rohit V.",
                likes: 12,
                comments: 2,
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-xs text-[#4B5563] mt-1">
                        by {p.author} •{" "}
                        <span className="inline-block bg-[#F3F4F6] text-[#4B5563] px-2 py-1 rounded">
                          {p.category}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="mt-2 text-sm text-[#4B5563]">
                    This is a short excerpt of the post to visualise card layout
                    and spacing.
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xl font-semibold text-[#111827]">
                    Stay safe on mountain trails
                  </div>
                  <div className="text-xs text-[#4B5563]">
                    by Amit S. • Safety Tips
                  </div>
                </div>
                <div className="text-sm text-[#4B5563]">👍 24 • 💬 8</div>
              </div>
              <div className="mt-3 text-sm text-[#4B5563]">
                Full post content goes here. This area shows an example of
                longer post text with line breaks and paragraphs for
                readability.
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white p-3 rounded-md shadow-sm">
                <div className="text-sm font-medium">
                  Priya R.{" "}
                  <span className="text-xs text-[#6B7280]">• 10m ago</span>
                </div>
                <div className="text-sm text-[#4B5563] mt-1">
                  Thanks for the tips! Any recommendations for safe trails for
                  beginners?
                </div>
              </div>
              ...
              <div className="bg-white p-3 rounded-md shadow-sm">
                ...
                <div className="text-sm text-[#4B5563] mt-1">
                  Use proper shoes and inform local guards. Also, check weather
                  updates.
                </div>
              </div>
            </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg font-semibold">
            Chat with Guardian (Mockup)
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex gap-4">
            <div
              className="w-80 bg-white rounded-lg p-3 shadow-md flex flex-col"
              style={{ borderRadius: 12 }}
            >
              <div className="font-semibold">
                Chat with Tourist: Amit Sharma
              </div>
              <div className="flex-1 overflow-auto mt-3 space-y-3">
                <div className="text-sm text-[#4B5563] bg-[#F3F4F6] p-2 rounded-md max-w-[80%]">
                  Hello Amit, are you safe?
                </div>
                <div className="text-sm self-end bg-[#4F46E5] text-white p-2 rounded-md max-w-[80%]">
            ...
            <div className="flex-1">
              ...
              >
                ...
                <div className="text-sm text-[#4B5563] mt-2">
                  Started: Today, 09:32 • Status: Active
                </div>
                <div className="mt-3 text-sm text-[#4B5563]">
                  <strong>Location:</strong> City Center • <strong>ETA:</strong>{" "}
                  12 mins
                </div>
              </div>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              { name: "Ramesh K", pts: 1240 },
              { name: "Anita P", pts: 1120 },
              { name: "Suresh D", pts: 980 },
            ].map((g, i) => (
              <div
                key={i}
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg font-semibold">
            Guardian Profile — Badges
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex items-center gap-4">
            <div className="w-24 h-24 rounded-full bg-[#F3F4F6] flex items-center justify-center font-bold text-[#4F46E5]">
              RK
            </div>
            <div>
