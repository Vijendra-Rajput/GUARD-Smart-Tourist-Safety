    ...
    <div className="flex flex-col items-center">
      <svg width={size} height={size} className="block">
        ...
        <text
          ...
          textAnchor="middle"
          className="text-sm font-semibold fill-current text-white"
    ...
    <Card className="card-hover">
      ...
      <CardContent>
        <div className="flex items-center gap-3">
          <div className="relative">
            <div
              className={`absolute -inset-1 rounded-full blur-xl opacity-30 bg-gradient-to-r ${pulseColor} animate-pulse-slow`}
              aria-hidden
            />
            ...
            >
              ...
              <circle
                ...
                fill="none"
                stroke={
                  risk <= 30 ? "#10b981" : risk <= 70 ? "#f59e0b" : "#ef4444"
                }
                strokeDasharray={`${(risk / 100) * 163} ${163 - (risk / 100) * 163}`}
  ...
  return (
    <div className="relative bg-black rounded-md overflow-hidden h-64 md:h-[50vh] lg:h-[60vh]">
      ...
      >
          ...
          path.map((p: any, i: number) => {
            ...
            const color =
              layer === "Safe"
                ...
                : layer === "RiskingSoon"
                  ? "rgba(245,158,11," + (0.06 + intensity * 0.18) + ")"
        ...
        {/* visiting markers */}
        {visitingMarkers &&
          visitingMarkers.map((p: any, idx: number) => (
            <g key={idx}>
...
function ReasonsPanel({
  ...
  reasons: { text: string; score: number; icon?: string }[];
}) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <ul className="space-y-3">
          {reasons.map((r, i) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="h-8 w-8 rounded-md bg-slate-800 flex items-center justify-center text-white text-sm">
                  {r.icon || "!"}
                </div>
                <div className="flex-1">
              ...
              <div className="w-full bg-slate-100 rounded-full h-2 mt-2 overflow-hidden">
                <div
                  className="h-2 bg-gradient-to-r from-red-400 to-red-600"
...
export default function DigitalTwin() {
  ...
  const [consent, setConsent] = useLocalStorage("dt-consent", {
    allowTracking: false,
    location: false,
    trust: false,
    ts: null,
  ...
  const [quickModesMessage, setQuickModesMessage] = useState<string | null>(
    null,
  );
  ...
  function generateWavyPath(h: number, segments = 6) {
    ...
    for (let i = 0; i < segments; i++) {
      ...
      pts.push([
        Math.max(2, Math.min(98, parseFloat(x.toFixed(2)))),
        Math.max(2, Math.min(98, parseFloat(y.toFixed(2)))),
      ]);
    }
    return pts;
  }
  ...
  const reasons = [
    {
      text: "Festival: high crowd density",
      score: Math.min(95, 30 + current.risk),
      icon: "🎉",
    },
    {
      text: "Recent local incidents: 2 in 48h",
      score: Math.min(90, 20 + current.risk),
      icon: "⚠️",
    },
    {
      text: "Weather alert: heavy",
      score: Math.min(85, 10 + current.risk),
      icon: "🌧️",
    },
  ];
  ...
  const memoryLog = [
    {
      title: "Safe Experience: navigated Paharganj market with no incidents",
      date: "Yesterday",
      color: "bg-emerald-400",
    },
    {
      title: "Risk Encountered: crowd density alert near Red Fort",
      date: "2 days ago",
      color: "bg-red-400",
    },
    {
      title: "Safe Experience: followed community-verified safe route",
      date: "3 days ago",
      color: "bg-emerald-400",
    },
  ];
    ...
    <div className="w-full">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Placeholder map—no external API
                  </div>
                </div>
              ...
              <MapPanel
                ...
                layer={layer}
                altPath={altPath}
                visitingMarkers={visitingMarkers}
              />
              ...
              <div className="mt-2">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                  ...
                  <div className="lg:col-span-2">
                    <Card className="bg-gradient-to-br from-sky-700/20 to-indigo-900/10 card-hover relative">
                      <CardHeader className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-lg bg-sky-600 flex items-center justify-center text-white text-lg">
                          💧
                        </div>
                        <div>
                      ...
                      <CardContent className="pt-2 relative">
                        <ul className="text-sm space-y-1">
                          ...
                          <li className="text-xs text-muted-foreground">
                            Advice: Verify official counters and fares
                          </li>
                        </ul>
                        <div className="absolute right-3 bottom-3 text-muted-foreground">
                          →
                  ...
                  <div>
                    <Card className="card-hover relative">
                      <CardHeader className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-lg bg-pink-600 flex items-center justify-center text-white text-lg">
                          📸
                        </div>
                        <div>
                          <CardTitle className="text-sm">AR Overlay</CardTitle>
                          <div className="text-xs text-muted-foreground">
                            Hotspots: 5 • Camera: disconnected
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent className="pt-2">
                        <div className="text-sm">
                          Preview AR overlays on camera (demo)
                        </div>
                        <div className="absolute right-3 bottom-3 text-muted-foreground">
                          →
                        </div>
                    ...
                    <Card className="card-hover">
                      <CardHeader className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground">
                            Top signals contributing to risk
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent className="pt-2">
                            ...
                            >
                              ...
                              <div className="w-full bg-slate-100 rounded-full h-2 mt-1 overflow-hidden">
                                <div
                                  ...
                                  style={{
                                    width:
                                      Math.max(8, Math.min(100, r.score)) + "%",
                                  }}
                                />
                              </div>
                            </li>
                  ...
                  <div>
                    <Card className="card-hover relative">
                      <CardHeader className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-lg bg-emerald-600 flex items-center justify-center text-white text-lg">
                          📦
                        </div>
                        <div>
                          <CardTitle className="text-sm">
                  ...
                  <div>
                    <Card className="card-hover relative">
                      <CardHeader className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-lg bg-sky-500 flex items-center justify-center text-white text-lg">
                          🤝
                        </div>
                        <div>
                          <CardTitle className="text-sm">
                          ...
                          <div className="text-xs text-muted-foreground">
                            Nearby: 4 �� Avg response: 3m
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent className="pt-2">
                        <div className="text-sm">
                          Last guardian online: 2m ago
                        </div>
                        <div className="absolute right-3 bottom-3 text-muted-foreground">
                          →
                        </div>
                  ...
                  <div>
                    <Card className="card-hover relative">
                      <CardHeader className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-lg bg-gray-700 flex items-center justify-center text-white text-lg">
                          ⚙️
                        </div>
                        <div>
                          <CardTitle className="text-sm">
                      ...
                      <CardContent className="pt-2">
                        <div className="flex flex-col gap-2">
                          <label className="text-xs flex items-center gap-2">
                            <input type="checkbox" /> Use synthetic ML
                          </label>
                          <label className="text-xs flex items-center gap-2">
                            <input type="checkbox" /> Show data sources
                          </label>
                          <div className="mt-2">
                            <div className="absolute right-3 bottom-3 text-muted-foreground">
                              →
              ...
              <Card className="card-hover">
                ...
                <CardContent>
                  <div className="flex items-center gap-3">
                    <div className="flex-1">
                      <div className="text-sm">
                        Risk Pulse corresponds to current risk bands
                      </div>
                      <div className="text-xs text-muted-foreground mt-2">
                        0-30: Green • 31-70: Orange • 71-100: Red
                      </div>
                    </div>
                  </div>
                </CardContent>
      ...
      >
        <div className="space-y-3">
          <p className="text-sm">
            This demo stores your consent locally only. No data leaves this
            device.
          </p>
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) =>
                setConsent({ ...consent, allowTracking: e.target.checked })
              }
            />
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) =>
                setConsent({ ...consent, location: e.target.checked })
              }
            />
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              onChange={(e) =>
                setConsent({ ...consent, trust: e.target.checked })
              }
            />
      ...
      >
        <div className="space-y-3">
          ...
          <div className="text-xs break-all bg-slate-100 p-2 rounded">
            {familyLink}
          </div>
          <div className="flex gap-2 items-center">
            ...
            {shareCopied && (
              <div className="text-sm text-emerald-600 ml-2">Copied</div>
            )}
          </div>
        </div>
      </FeatureModal>
      ...
      >
        <div className="space-y-3">
          <div className="text-sm">
            Preview alternative safe route (demo). You can apply this route to
            the map.
          </div>
          <div className="h-40 bg-slate-900/10 rounded p-2">
            Route preview shown on map overlay.
          </div>
          <div className="flex gap-2">
            <Button
              onClick={() => {
      ...
      {/* Visiting Modal */}
      <FeatureModal
        open={visitingModalOpen}
        title="Marking as Visiting"
        onClose={() => setVisitingModalOpen(false)}
      >
        <div className="space-y-3">
          <div className="text-sm">
            You've marked this destination as visiting. Family will be notified
            (demo)
          </div>
          <div className="flex gap-2">
      ...
      >
        <div className="space-y-3">
          <div className="text-sm">
            Hydration plan, rest spots, and battery-saving tips (demo).
          </div>
          <div className="flex gap-2">
      ...
      <FeatureModal
        open={parallelOpen}
        title="Parallel World Simulation"
        onClose={() => {
          ...
          <div className="w-2/3">
            <div className="h-64 bg-slate-900/10 rounded p-2 relative">
              ...
              <svg viewBox="0 0 100 100" className="w-full h-44 mt-2">
                <polyline
                  points={(simPath || []).map((p) => p.join(",")).join(" ")}
                  fill="none"
                  stroke="#06b6d4"
                  strokeWidth="0.8"
                  strokeLinecap="round"
                  className={simPath ? "dt-altpath" : ""}
                />
                {simPath && simPath[simIndex] && (
                  <g>
                    <circle
                      cx={simPath[simIndex][0]}
                      cy={simPath[simIndex][1]}
                      r="1.6"
                      fill="#06b6d4"
                    />
                    <circle
            ...
            <div className="space-y-3">
              ...
              <div className="p-2 bg-card rounded">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="font-semibold">{simData.crowd}%</div>
                </div>
                <div className="w-full bg-slate-100 rounded-full h-2 mt-1 overflow-hidden">
                  <div
                    className="h-2 bg-amber-400"
                    style={{ width: simData.crowd + "%" }}
                  />
                </div>
                <div className="flex items-center justify-between text-sm mt-2">
                  <div>Community Trust</div>
                  <div className="font-semibold">
                    {(simData.trust / 10).toFixed(1)}/5
                  </div>
                </div>
                <div className="text-sm mt-1">
                  CCTV: {simData.cctv ? "Detected" : "Not detected"}
                </div>
                <div className="text-sm mt-1">
                  Nearest Police Booth: {simData.police}m
                </div>
                {simBlocked && (
                  <div className="mt-3 p-2 rounded bg-red-100 text-red-700 font-semibold">
                    ALERT: Route Ahead Blocked Due to High Security Risk
                  </div>
                )}
              </div>
            </div>
      ...
      <FeatureModal
        ...
        title="Quick Modes"
        onClose={() => {
          setQuickModesOpen(false);
          setQuickModesMessage(null);
        }}
      >
        <div className="space-y-3">
          <div className="text-sm">
            Silent Alarm, Watch Mode and quick settings (demo)
          </div>
          <div className="flex flex-col gap-2">
            <Button
              onClick={() => {
                setQuickModesMessage("Silent Alarm sent quietly (demo)");
              }}
            ...
            <Button
              onClick={() => {
                setQuickModesMessage(
                  "Watch Me started — family notified (demo)",
                );
              }}
              aria-label="Watch Me"
            >
            ...
            {quickModesMessage && (
              <div className="p-2 rounded bg-slate-100 text-sm text-muted-foreground">
                {quickModesMessage}
              </div>
            )}
      ...
      >
        <div className="space-y-3">
          <div className="text-sm">
            Logs: Location pinned, photo stored, blockchain hash (demo)
          </div>
          <div className="flex gap-2">
      ...
      >
        <div className="space-y-3">
          <div className="text-sm">
            AR Overlay mock preview (icons overlayed on camera) — demo only.
          </div>
          <div className="flex gap-2">
